...
import { RiInstagramFill } from "react-icons/ri"; // Importing only one arrow icon
import "./index.css";
...
function Footer() {
  ...
  const toggleMettaMuse = () => {
    setMettaMuseOpen((prevState) => !prevState); // Toggle the Metta Muse dropdown
  };

  const toggleQuickLinks = () => {
    setQuickLinks((prevState) => !prevState); // Toggle the Metta Muse dropdown
  };

  const toggleFollowUp = () => {
    setFollowUs((prevState) => !prevState); // Toggle the Metta Muse dropdown
  };
      ...
      <section className="lgTopMain">
        <section className="mettaMuseSection">
          <div className="dropdownContainer" onClick={toggleMettaMuse}>
            ...
            <FaChevronUp
              size={24}
              className={`arrow ${isMettaMuseOpen ? "rotated" : ""}`} // Rotate the arrow when the dropdown is open
            />
          </div>
        ...
        <section className="mettaMuseSection">
          <div className="dropdownContainer" onClick={toggleQuickLinks}>
            ...
            <FaChevronUp
              size={24}
              className={`arrow ${isQuickLinksOpen ? "rotated" : ""}`} // Rotate the arrow when the dropdown is open
            />
          </div>
        ...
        <div className="subbottom">
          ...
          <section className="mettaMuseSection">
            <div className="dropdownContainer" onClick={toggleFollowUp}>
              ...
              <FaChevronUp
                size={24}
                className={`arrow ${isFollowUsOpen ? "rotated" : ""}`} // Rotate the arrow when the dropdown is open
              />
            </div>
